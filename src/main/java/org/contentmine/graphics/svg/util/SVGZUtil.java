...
public class SVGZUtil {

	private final static Logger LOG = Logger.getLogger(SVGZUtil.class);
	...
	public static void writeToSVGFile(File dir, String filename,SVGElement svgElement, boolean debug) {
		...
		try {
			if (!filename.endsWith(SVGZConstants.DOT_SVG)) {
				filename += SVGZConstants.DOT_SVG;
			}
